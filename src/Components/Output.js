  ...
  render() {
    ...
    return (
      <div className="output">
        ...
        <h3>{weight}</h3>
        <h3>{bmi}</h3>
        <h3 className={(this.props.data.bmiClass === "Obese") ? "danger" : ""}>{bmiClass} {(this.props.data.bmiClass === "Obese") ? <a href='http://google.com'>What can I do?</a> : ""}</h3>
      </div>
    );
  }
}
